  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mx-auto max-w-3xl">
        ...
        {isCancelled && (
          <div className="mb-8 rounded-lg border border-destructive/20 bg-destructive/5 p-6 text-center">
          ...
          <div className="space-y-6">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      {order.deliveryAddress || "Pickup from seller"}
                    </p>
                  </div>
                </div>
            ...
            <div className="rounded-lg border bg-card p-6">
              <h2 className="mb-4 font-semibold">Seller</h2>
                ...
                <div>
                  <p className="font-medium">
                    {[order.seller.firstName, order.seller.lastName].filter(Boolean).join(" ").trim() ||
                      order.seller.name}
                  </p>
                  <Link
