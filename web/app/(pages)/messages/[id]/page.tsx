        ...
        {messages.length === 0 && !isConnecting ? (
          <div className="flex h-full flex-col items-center justify-center gap-2 text-center">
            ...
            {conversation.product && (
              ...
              >
                {conversation.product.image && (
                  <img src={conversation.product.image} alt="" className="h-8 w-8 rounded-lg object-cover" />
                )}
      ...
      >
        <div className="flex items-end gap-2">
          <Textarea
            ...
            rows={1}
            className="max-h-[120px] min-h-[40px] flex-1 resize-none overflow-hidden py-2.5 text-sm leading-relaxed"
          />
          <Button
            type="submit"
            size="icon"
