...
export function SearchPageContent() {
  ...
  const [searchType, setSearchType] = useState<SearchType>((searchParams.get("type") as SearchType) || "products")
  ...
  const FiltersSidebar = () => (
    <div className="space-y-6">
      ...
      <div>
        ...
        <RadioGroup value={searchType} onValueChange={(v) => setSearchType(v as SearchType)} className="space-y-2">
          <div className="flex items-center space-x-3 p-2 rounded-lg hover:bg-muted transition-colors">
            <RadioGroupItem value="products" id="products" />
            <Label htmlFor="products" className="flex items-center gap-2 cursor-pointer flex-1">
          ...
          <div className="flex items-center space-x-3 p-2 rounded-lg hover:bg-muted transition-colors">
            ...
            <Label htmlFor="stores" className="flex items-center gap-2 cursor-pointer flex-1">
          ...
          <div className="flex items-center space-x-3 p-2 rounded-lg hover:bg-muted transition-colors">
            ...
            <Label htmlFor="food" className="flex items-center gap-2 cursor-pointer flex-1">
        ...
        <CollapsibleContent className="pt-2">
          <RadioGroup value={selectedCategory} onValueChange={setSelectedCategory} className="space-y-1">
            <div className="flex items-center space-x-3 p-2 rounded-lg hover:bg-muted transition-colors">
              ...
              <Label htmlFor="all-categories" className="cursor-pointer flex-1 text-sm">
                All Categories
              </Label>
            </div>
            {categories.map((category) => (
              ...
              >
                ...
                <Label htmlFor={category.id} className="cursor-pointer flex-1 text-sm flex justify-between">
        ...
        <CollapsibleContent className="pt-2 space-y-1">
          {conditions.map((condition) => (
            ...
            >
              ...
              />
              <Label htmlFor={`condition-${condition.id}`} className="cursor-pointer flex-1 text-sm">
                {condition.label}
              </Label>
            </div>
          ))}
      ...
      <Collapsible open={priceOpen} onOpenChange={setPriceOpen}>
        ...
        <CollapsibleContent className="pt-4">
          <Slider value={priceRange} onValueChange={setPriceRange} min={0} max={10000} step={100} className="mb-4" />
    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6">
      ...
      <form onSubmit={handleSearch} className="mb-6">
        <div className="relative max-w-2xl">
          ...
          <Input
            type="search"
            placeholder="Search products, stores, or food..."
            value={searchQuery}
      ...
      {(selectedCategory || selectedConditions.length > 0) && (
        <div className="flex flex-wrap items-center gap-2 mb-4">
          ...
          <button onClick={clearAllFilters} className="text-sm text-emerald-600 hover:underline">
            Clear all
          </button>
        </div>
      )}
      ...
      <div className="flex gap-8">
        ...
        <div className="flex-1 min-w-0">
          ...
          {mockProducts.length > 0 ? (
            <div
              className={cn(
                viewMode === "grid" ? "grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4" : "flex flex-col gap-4",
              )}
            >
