...
import { ArrowLeft, Package, DollarSign, TrendingUp, Eye, MessageSquare, Settings, Plus } from "lucide-react"
...
export default function SellerDashboardPage() {
  const stats = [
    { label: "Active Listings", value: "0", icon: Package, color: "text-blue-600" },
    { label: "Total Sales", value: "$0", icon: DollarSign, color: "text-green-600" },
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-muted-foreground mt-2">Manage your listings and track your sales performance</p>
          </div>
          <Link href="/sell">
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-primary/10 to-primary/5 rounded-xl border border-primary/20 p-6">
              <h3 className="text-lg font-semibold text-foreground mb-2">Selling Tips</h3>
              ...
              <Link href="/help/selling" className="text-sm text-primary hover:underline mt-3 inline-block">
                Read full guide →
              </Link>
            </div>
          </div>
